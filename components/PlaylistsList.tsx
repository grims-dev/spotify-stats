          ...
          return (
            <li key={item.id}>
              <Link href={`/playlist-stats?id=${item.id}`} passHref>
                <a className="flex items-center h-full w-full break-words overflow-hidden rounded-lg bg-gray-300 bg-opacity-10 border border-gray-700 transform transition duration-200 hover:bg-opacity-5 hover:shadow-lg hover:-translate-y-1">
